...
public class signupfrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        username = v.findViewById(R.id.signupusername);
         ...
         frname = v.findViewById(R.id.signupfirstname);
         lsname = v.findViewById(R.id.signuplastname);
         passw1 = v.findViewById(R.id.signuppassword1);
         passw2 = v.findViewById(R.id.signuppassword2);
